        ...
        <div className="p-4 flex flex-col h-full">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <button className="w-full flex items-center gap-3 px-4 py-2 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-colors">
          ...
          <div className="mt-auto pt-6 border-t border-gray-200 dark:border-gray-700">
            <div className="text-xs text-gray-500 dark:text-gray-400">
              <p>Version 1.0.0</p>
              <p className="mt-1">© 2024 Optimus GPT. All rights reserved.</p>
            </div>
          </div>
        </div>
      </div>
